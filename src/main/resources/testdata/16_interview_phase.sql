...
('interview-phase-019', 'applicant-019', '2025-03-31', 'FAIL', NOW(), NOW()),
('interview-phase-020', 'applicant-020', '2025-04-01', 'EVALUATING', NOW(), NOW()),
('interview-phase-021', 'applicant-021', '2025-04-02', 'PASS', NOW(), NOW()),
('interview-phase-022', 'applicant-022', '2025-04-03', 'FAIL', NOW(), NOW()),
('interview-phase-023', 'applicant-023', '2025-04-04', 'EVALUATING', NOW(), NOW()),
('interview-phase-024', 'applicant-024', '2025-04-05', 'PASS', NOW(), NOW()),
('interview-phase-025', 'applicant-025', '2025-04-06', 'FAIL', NOW(), NOW()),
('interview-phase-026', 'applicant-026', '2025-04-07', 'EVALUATING', NOW(), NOW()),
('interview-phase-027', 'applicant-027', '2025-04-08', 'PASS', NOW(), NOW()),
('interview-phase-028', 'applicant-028', '2025-04-09', 'FAIL', NOW(), NOW()),
('interview-phase-029', 'applicant-029', '2025-04-10', 'EVALUATING', NOW(), NOW()),
('interview-phase-030', 'applicant-030', '2025-04-11', 'PASS', NOW(), NOW()),
('interview-phase-031', 'applicant-031', '2025-03-29', 'FAIL', NOW(), NOW()),
('interview-phase-032', 'applicant-032', '2025-03-30', 'EVALUATING', NOW(), NOW()),
('interview-phase-033', 'applicant-033', '2025-03-31', 'PASS', NOW(), NOW()),
('interview-phase-034', 'applicant-034', '2025-04-01', 'FAIL', NOW(), NOW()),
('interview-phase-035', 'applicant-035', '2025-04-02', 'EVALUATING', NOW(), NOW()),
('interview-phase-036', 'applicant-036', '2025-04-03', 'PASS', NOW(), NOW()),
('interview-phase-037', 'applicant-037', '2025-04-04', 'FAIL', NOW(), NOW()),
('interview-phase-038', 'applicant-038', '2025-04-05', 'EVALUATING', NOW(), NOW()),
('interview-phase-039', 'applicant-039', '2025-04-06', 'PASS', NOW(), NOW()),
('interview-phase-040', 'applicant-040', '2025-04-07', 'FAIL', NOW(), NOW());
